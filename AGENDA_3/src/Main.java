...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.printf("Você deseja:%n1 - Adicionar novo contato%n2 - Pesquisar um contato%n3 - Imprimir todos os contatos%n4 - Imprimir contatos por letra do nome%n5 - Encerrar%n");
    ...
    private static void imprimirContatosPorletra() {
        Scanner imprimirContatos = new Scanner(System.in);
        System.out.println("Digite a letra do nome:");

        char letra = imprimirContatos.next().charAt(0);

        System.out.println("Contatos cujo nome começa com '" + letra + "':");

        boolean encontrouContato = false;

        for (int i = 0; i < poxicaoAtualAgenda; i++) {
            if (nomesDaAgenda[i].toLowerCase().charAt(0) == Character.toLowerCase(letra)) {
                System.out.println("Nome: " + nomesDaAgenda[i]);
                System.out.println("Número: " + numerosDaAgenda[i]);
                System.out.println("E-mail: " + emailsDaAgenda[i]);
                System.out.println(" ");
        ...
        if (!encontrouContato) {
            System.out.println("Nenhum contato encontrado com a letra '" + letra + "'.");
        }
    }
}
